...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up HA DHD Ember+ from a config entry."""
    ...
    coordinator = DHDEmberCoordinator(hass, client, entry)
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unload_ok:
        coordinator: DHDEmberCoordinator = hass.data[DOMAIN].pop(entry.entry_id)
